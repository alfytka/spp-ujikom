...
<div class="row">
  <div class="col-lg-8">
    <div class="alert alert-light border-zinc roundeds alert-dismissible fade show" role="alert">
      ...
      <span class="fw-bold fst-italic">Hello, selamat datang {{ auth()->user()->username }}</span>
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      ...
      <div class="row">
        ...
        <!-- Data Kelas Card -->
        <div class="col-xxl-8 card-sm-right col-md-8 col-6">
          <div class="card slate-card info-card revenue-card">
        ...
        <!-- Data Kelas Card -->
        <div class="col-xxl-6 card-sm-right col-md-6 col-6">
          <div class="card danger-card info-card revenuex-card">
        ...
        <!-- Data Kelas Card -->
        <div class="col-xxl-8 card-sm-left col-md-8 col-6">
    ...
    {{-- <div class="col-lg-4">
      <div class="row">
        ...
        <!-- Data Kelas Card -->
        <div class="col-xxl-8 card-sm-right col-md-10 col-6">
         <div class="card green-card info-card revenue2-card">
