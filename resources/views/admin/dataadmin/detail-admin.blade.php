            ...
            <div class="col-6 text-end">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="/dataadmin/{{ $dataadmin->id }}/edit" class="dropdown-item">Edit Data <i class="bi bi-chevron-right float-end"></i></a></li>
                  <li><a href="/dataadmin/{{ $dataadmin->id }}/upload-photo" class="dropdown-item">Unggah Foto <i class="bi bi-person-bounding-box float-end"></i></a></li>
                </ul>
              </div>
            </div>
          </div>
