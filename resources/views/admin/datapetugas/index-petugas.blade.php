...
<div class="pagetitle">
  <h5 class="fw-semibold">Data Petugas <span class="float-end d-inline d-md-none"><a href="#q"><i class="bi bi-plus-circle-dotted"></i> <span class="fs-12 fw-normal">Petugas</span></a></span></h5>
</div>
          ...
          <div class="table-responsive mt-4 mt-md-3 mt-lg-3">
            <table class="table table-sm" id="table1">
              <thead>
                <tr>
                  <th scope="col">#</th>
                  <th scope="col">Nama <span class="d-none d-md-inline d-lg-inline">Petugas</span></th>
              ...
              <tr>
                ...
                <td style="min-width: 180px;">{{ $petugas->name }}</td>
                ...
                <td class="align-middle">
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="/datapetugas/{{ $petugas->id }}/edit" class="dropdown-item">Edit <i class="bi bi-pen float-end"></i></a></li>
                      <li><a href="/datapetugas/{{ $petugas->id }}" class="dropdown-item">Detail <i class="bi bi-text-wrap float-end"></i></a></li>
                      <div class="border-bottom mx-2"></div>
                      <li>
                        <a href="" data-bs-toggle="modal" data-bs-target="#datapetugas{{ $petugas->id }}" class="dropdown-item text-danger">Hapus <i class="bi bi-trash3 float-end"></i></a>
                      </li>
                    </ul>
                  </div>
                </td>

                <div class="modal modal-sm fade py-5" id="datapetugas{{ $petugas->id }}" tabindex="-1" data-bs-backdrop="false">
                  <div class="modal-dialog">
                    <div class="modal-content rounded-4 shadow">
                      ...
                      <div class="modal-body py-0 mb-1 fs-12">
                        Hapus data petugas?<br>
                        <span class="text-violet fw-semibold fst-italic"> <i class="bi bi-arrow-return-right"></i> {{ $petugas->name }}</span>
                      </div>
                      <div class="modal-footer flex-column border-top-0">
                        <form action="/datapetugas/{{ $petugas->id }}" method="POST">
                          @csrf
                          @method('DELETE')
