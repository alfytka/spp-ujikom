...
@section('titles')
  <title>SPP - Unggah Foto Petugas</title>
@endsection
@section('content')
    ...
    <div class="col-md-7 col-lg-6">
      <div class="cardxy border-none shadow-sm">
        <div class="card-body">
          <div class="row">
            <div class="col-12">
              <h5 class="card-title ms-1">Unggah Foto Petugas</h5>
            </div>
          </div>
          ...
          <form class="row g-3 mx-0 mx-md-1 mx-lg-1 mb-3" action="/datapetugas/{{ $datapetugas->id }}/upload-photo" enctype="multipart/form-data" method="POST">
            ...
            <div class="col-12 col-md-12 col-lg-12 detail-form">
              ...
              <div class="form-group mb-2">
                <label for="foto" class="form-label mb-1">Unggah Foto</label>
              ...
              <div class="text-end">
                <button type="submit" class="btnn btn-violet py-2 px-4 mt-1 mb-2">Simpan</button>
              </div>
