      ...
      <div class="card">
        <div class="row mx-0 mx-md-4 mx-lg-4 mb-4 mt-2">
          ...
          <div class="col-7 d-flex flex-row-reverse">
            <h6 class="text-end"><a href="/profile/edit"><span class="d-none d-md-inline d-lg-inline">Edit</span> Profile</a><i class="bi bi-chevron-right ms-2"></i></h6>
          </div>
        </div>
          ...
          <div class="row mx-0 mx-md-4 mx-lg-4 mb-5">
            <div class="col-12 col-md-6 col-lg-6">
              ...
              <div class="alert alert-light border-zinc roundeds alert-dismissible fade show" role="alert">
                ...
                <span class="fs-12"><b>Error - </b>{{ session('informasi') }}</span>
              ...
              <div class="col-12 mb-3 pe-0 pe-md-3 pe-lg-3">
                ...
                <input type="password" class="form-control form-control-smx roundedx mt-1 @error('current_password') is-invalid @enderror" autocomplete="off" name="current_password" id="current_password" placeholder="Masukkan password sebelumnya">
              ...
              <div class="col-12 mb-3 pe-0 pe-md-3 pe-lg-3">
                ...
                <input type="password" class="form-control form-control-smx roundedx mt-1 @error('new_password') is-invalid @enderror" autocomplete="off" name="new_password" id="new_password" placeholder="Password baru">
                @error('new_password')
                <span class="invalid-feedback">{{ $message }}</span>
                @enderror
              </div>
              <div class="col-12 mb-3 pe-0 pe-md-3 pe-lg-3">
                ...
                <input type="password" class="form-control form-control-smx roundedx mt-1 @error('konfirmasi_password') is-invalid @enderror" autocomplete="off" name="konfirmasi_password" id="konfirmasi_password" placeholder="Ulangi password">
