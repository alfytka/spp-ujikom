          ...
          <div class="row mx-0 mx-md-4 mx-lg-4 mb-5">
            <div class="col-12 col-md-6 col-lg-6">
              ...
              <div class="col-12 mb-3">
                ...
                <input type="password" class="form-control roundedx @error('current_password') is-invalid @enderror" autocomplete="off" name="current_password" id="current_password" placeholder="Masukkan password sebelumnya">
              ...
              <div class="col-12 mb-3">
                ...
                <input type="password" class="form-control roundedx @error('new_password') is-invalid @enderror" autocomplete="off" name="new_password" id="new_password" placeholder="Password baru">
                @error('new_password')
                <span class="invalid-feedback">{{ $message }}</span>
                @enderror
              </div>
              ...
              <div class="col-12 mb-3">
                ...
                <input type="password" class="form-control roundedx @error('konfirmasi_password') is-invalid @enderror" autocomplete="off" name="konfirmasi_password" id="konfirmasi_password" placeholder="Ulangi password">
              ...
              <div class="col-12 col-md-12 col-lg-12 d-none d-md-inline d-lg-inline detail-form">
                ...
                <div class="col-12 mb-2">
                  <div class="row ">
                    ...
                    <h6 class="mb-0 fw-normal text-primary">{{ auth()->user()->telepon }}</h6>
                  </div>
                </div>
