...
@section('content')
    ...
    <div class="pagetitle">
        <h5 class="fw-semibold">Hello, Alfitka <span class="d-block fw-normal fs-12">Aplikasi Pembayaran SPP
                disini...</span></h5>
    </div>
                        ...
                        <div class="card green-card info-card revenue2-card" style="height: 300px;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="align-items-center">
                                    ...
                                    <div
                                        class="card-icon rounded-circle d-flex mt-3 align-items-center justify-content-center">
                            ...
                            <div class="card-body">
                                ...
                                <div class="align-items-center">
                                    ...
                                    <div class="count text-center mt-4">
                                        <i class="bi bi-chevron-down"></i>
                                        <h4 class="pb-0 mb-0">
                                            <small>Rp</small>{{ number_format($datasiswa->spp->nominal, 0, '.', '.') }}<small
                                                class="fs-10 fw-normal">/bulan</small></h4>
                                        <i class="bi bi-chevron-up"></i>
                                    </div>
                                    <div class="border-bottom mt-2"></div>
                                    <div
                            ...
                            <div class="card-body">
                                ...
                                <div class="align-items-center">
                                    ...
                                    <div class="fiturname mt-2 pt-1">
                                        <span class="fitur-name text-violet">Bulan Pembayaran <i
                                                class="fs-6">spp</i></span>
                                    </div>
                                        ...
                                        <table class="table table-sm table-borderless">
                                            @foreach ($berandasiswa as $siswa)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#">
                                                            <span class="badge btn-violet">{{ $siswa->bulan_bayar }} -
                                                                {{ $siswa->tahun_bayar }}</span>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="#" class="text-violet">
                                                            <span class="fs-10"><span class="d-none d-md-inline">Nominal -
                                                                </span>{{ number_format($siswa->jumlah_bayar, 0, '.', '.') }}</span>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="#">
                            ...
                            <div class="card-body">
                                ...
                                <div class="align-items-center">
                                    ...
                                    <div class="d-flex" style="font-family: Quicksand;">
                                        <div
                                            class="card-icon rounded-circle d-flex mt-4 align-items-center justify-content-center">
                                    ...
                                    <div class="fiturname">
                                        ...
                                        <p>berapa sih nominal spp yang harus dibayarkan tiap bulannya sesuai dengan tahun
                                            spp siswa (saya)?</p>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="align-items-center">
                                    ...
                                    <div class="fiturname">
                                        ...
                                        <p>Cek kembali data profil kamu, bisa dengan kunjungi laman profil siswa atau klik
                                            pranala (tautan) dibawah ini.</p>
                                    </div>
