            ...
            <div class="col-lg-10">
                ...
                <div class="cardxy shadow-sm">
                    <div class="card-body">
                        ...
                        <form class="row g-3 mx-0 mx-md-1 mx-lg-1 mb-3"
                            action="/siswa/{{ auth()->user()->id }}/entri-pembayaran" method="POST"
                            ...
                            <div class="col-12 col-md-6 col-lg-6 pe-2 pe-md-3 pe-lg-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="kelas_id"
                                        class="form-select form-select-smx roundedx @error('kelas_id') is-invalid @enderror"
                                        id="kelas_id">
                                        <option disabled value>- Pilih kelas -</option>
                                        <option value="{{ auth()->user()->kelas->id }}">{{ auth()->user()->kelas->kelas }}
                                        </option>
                                    </select>
                                    @error('kelas_id')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="siswa_id"
                                        class="form-select form-select-smx roundedx @error('siswa_id') is-invalid @enderror"
                                        id="siswa_id">
                                    ...
                                    <div class="col-6 pe-2">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="date" name="tgl_bayar" value="{{ old('tgl_bayar') }}"
                                                class="form-control form-control-smx roundedx @error('tgl_bayar') is-invalid @enderror"
                                                id="tgl_bayar">
                                        </div>
                                    </div>
                                    <div class="col-6 ps-2  ">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="bulan_bayar" id="bulan_bayar"
                                                class="form-select form-select-smx roundedx @error('bulan_bayar') is-invalid @enderror">
                                ...
                                <div class="row">
                                    <div class="col-6 pe-2">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" value="{{ old('tahun_bayar') }}"
                                                class="form-control form-control-smx roundedx @error('tahun_bayar') is-invalid @enderror"
                                                name="tahun_bayar" placeholder="ex: 2020" autocomplete="off"
                                                id="tahun_bayar">
                                        </div>
                                    </div>
                                    <div class="col-6 ps-2  ">
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="jumlah_bayar"
                                                    class="form-control form-control-smx rounded-r @error('jumlah_bayar') is-invalid @enderror"
                                                    value="{{ number_format(auth()->user()->spp->nominal, 0, '', '') }}"
                                                    placeholder="100.000" id="jumlah_bayar" autocomplete="off" readonly>
                                                @error('jumlah_bayar')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="jenis_pembayaran"
                                        class="form-select form-select-smx roundedx @error('jenis_pembayaran') is-invalid @enderror"
                                        id="jenis_pembayaran">
                            ...
                            <div class="col-12 col-md-6 col-lg-6 ps-2 ps-md-3 ps-lg-3 mt-0 mt-md-3 mt-lg-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="metode_pembayaran"
                                        class="form-select form-select-smx roundedx @error('metode_pembayaran') is-invalid @enderror"
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="file"
                                        class="form-control roundedx @error('foto_bukti') is-invalid @enderror"
                                        name="foto_bukti" id="foto_bukti" onchange="loadFile(event)" accept="image/*">
                                    @error('foto_bukti')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 border roundedx mb-2 text-center overflow-hidden">
                                    <img src="/img/defaultbukti.jpg" alt="buktitransfer" class=""
                                        style="height: 237px; max-width:330px; object-fit: contain;" id="output">
                                </div>

                                <div class="text-end ">
                                    <button type="submit" class="btnn btn-violet py-2 ps-4 mt-1 mb-3">Ajukan Pembayaran
                                        <i class="bi bi-chevron-right px-1"></i></button>
                                </div>
                            </div>
