    ...
    <div class="col-12 col-md-12 col-lg-12">
      ...
      <div class="card">
        <div class="row mx-0 mx-md-4 mx-lg-4 mb-4 mt-2">
          <div class="col-5">
            <h6><i class="bi bi-chevron-left me-2"></i><a class="fc-black" href="/profile-siswa">Kembali</a></h6>
          </div>
          <div class="col-7 d-flex flex-row-reverse">
            <h6 class="text-end"><a class="fc-black" href="/profile-siswa/password"><span class="d-none d-md-inline d-lg-inline">Ubah</span> Password</a><i class="bi bi-chevron-right ms-2"></i></h6>
          </div>
        </div>
          ...
          <div class="row mx-0 mx-md-4 mx-lg-4 mb-5">
            <div class="col-12 col-md-6 col-lg-6">
              ...
              <div class="mt-1 mb-4 d-flex flex-column align-items-center">
                @if (auth()->user()->foto > 1)
                  <img src="/img/photo-siswa/{{ auth()->user()->foto }}" alt="Profile" class="profile-img rounded-circle border" id="output">
                @else
