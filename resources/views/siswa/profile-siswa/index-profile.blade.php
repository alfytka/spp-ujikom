                ...
                <div class="card">
                    <div class="row mx-0 mx-md-4 mx-lg-4 mb-4 mt-2">
                        ...
                        <div class="col-7 d-flex flex-row-reverse">
                            <h6 class="text-end d-none d-md-flex d-lg-flex"><a class="fc-black"
                                    href="/profile-siswa/password">Edit Password</a><i
                                    class="bi bi-chevron-right ms-0 ms-md-2"></i></h6>
                            <h6 class="text-end me-0 me-md-3 me-lg-3"><a class="fc-black" href="/profile-siswa/edit">Edit
                                    <span class="d-none d-md-inline d-lg-inline">Profile</span></a><i
                                    class="bi bi-chevron-right ms-0 ms-md-2"></i></h6>
                        </div>
                    </div>
                            ...
                            <div class="col-12 col-md-12 col-lg-12 detail-form">
                                ...
                                <div class="col-12 mb-2">
                                    <div class="row ">
                                        ...
                                        <div class="col-3 my-auto text-end">
                                            <h6 class="fw-normal"><i class="fs-6 text-primary me-2 me-md-3 me-lg-3">spp</i>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
