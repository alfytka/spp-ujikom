                ...
                <div class="card">
                    <div class="row mx-0 mx-md-4 mx-lg-4 mb-4 mt-2">
                        ...
                        <div class="col-7 d-flex flex-row-reverse">
                            <h6 class="text-end"><a class="fc-black" href="/profile-siswa/edit"><span
                                        class="d-none d-md-inline d-lg-inline">Edit</span> Profile</a><i
                        ...
                        <div class="row mx-0 mx-md-4 mx-lg-4 mb-5">
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                @if (session()->has('informasi'))
                                    <div class="alert alert-light border-zinc roundeds alert-dismissible me-0 me-md-3 fade show"
                                        role="alert">
                                ...
                                <div class="col-12 mb-3 pe-0 pe-md-3 pe-lg-3">
                                    ...
                                    <input type="password"
                                        class="form-control form-control-smx mt-1 roundedx @error('current_password') is-invalid @enderror"
                                        autocomplete="off" name="current_password" id="current_password"
                                ...
                                <div class="col-12 mb-3 pe-0 pe-md-3 pe-lg-3">
                                    ...
                                    <input type="password"
                                        class="form-control form-control-smx mt-1 roundedx @error('new_password') is-invalid @enderror"
                                        autocomplete="off" name="new_password" id="new_password"
                                ...
                                <div class="col-12 mb-3 pe-0 pe-md-3 pe-lg-3">
                                    ...
                                    <input type="password"
                                        class="form-control form-control-smx mt-1 roundedx @error('konfirmasi_password') is-invalid @enderror"
                                        autocomplete="off" name="konfirmasi_password" id="konfirmasi_password"
                                ...
                                <div class="col-12 text-end pe-0 pe-md-3 pe-lg-3">
                                    <button type="submit" class="btnn btn-ol-violet ps-4 roundedx">Simpan <i
